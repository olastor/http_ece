...
export class ECECrypto {
  ...
  public readonly crypto: dntShim.SubtleCrypto;
  ...
  private cek: dntShim.CryptoKey | null = null;
  ...
  protected async getCEK(): Promise<dntShim.CryptoKey> {
  ...
  protected async hmacSha256(
    secret: dntShim.CryptoKey | ArrayBuffer,
    body: ArrayBuffer,
    length?: number,
  ): Promise<ArrayBuffer> {
