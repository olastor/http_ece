...
function importKey(key: Key): Promise<dntShim.CryptoKey> {
...
function sign(data: Data, key: dntShim.CryptoKey): Promise<ArrayBuffer> {
...
export class KeyStack {
  #cryptoKeys = new Map<Key, dntShim.CryptoKey>();
  #keys: Key[];

  async #toCryptoKey(key: Key): Promise<dntShim.CryptoKey> {
