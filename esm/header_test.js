...
import { assert, assertEquals, assertFalse, assertNotEquals, assertThrows, } from "./dev_deps.js";
...
dntShim.Deno.test("Header/toBytes", () => {
    ...
    assert(bytes.equals(new Uint8Array(h.toBytes()), bytes.concat(innerSalt, rs, idlen, h.keyid)));
});
